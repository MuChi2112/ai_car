...
if __name__ == "__main__":
    ...
    game_info = GameInfo()
    check_point = CheckPoint(CHECK_POINT_MASK)
    ...
    while run:
        ...
        draw(WIN, images, player_car, game_info, x_offset, y_offset, MAIN_FONT, HEIGHT, TRACK_BORDER_MASK)
        ...
        check_point.check_point_check(player_car, CHECK_POINT_MASK)
